...
console.log("Name element pools generated.");
...
createplacenamepoolGrammar();
var placenamepool = [smallword, oneword, oneword2, twowords];
console.log("Names generated: " + smallword + ", " + oneword + ", " + oneword2 + ", " twowords + ", Nighthead.");

console.log("//---------------------------- OPTIONAL MUTATIONS")

for (i = 0; i < placenamepool.length; i++) {
  optionalMutations(placenamepool[i]);
}

finalsmallword = placenamepool[0];
finaloneword = placenamepool[1];
finaloneword2 = placenamepool [2]
finaltwoword = placenamepool[3];
...
"oneword2":["#oneclause#", "#oneclause#", "#oneclause#", "#oneclause#", "#oneclause#", "#oneclause#", "#oneclause#", "#oneclause#", "#twoclause#", "#twoclause#", "#twoclause#", "#twoclause#", "#twoclause#",  "#twoclause#","#threeclause#", "#threeclause#"],

"twowords":["#oneword#", "#oneword#"],

"smallword":["#oneclause#", "#oneclause#", "#twoclause#"],

oneword = grammar.flatten("#oneword#");
smallword = grammar.flatten("#smallword#");
twowords = grammar.flatten("#twowords#");
oneword2 = grammar.flatten("#oneword2#");
...
case 1:
// LATIN
variantArray = [finaloneword + " Parva", finaloneword + "Magna", finaloneword + " Superior", finaloneword + " Regis", finaloneword + " Episcopi", finaloneword + " Abbas", finaloneword + " Abbey", finaloneword + "-cum-" + finaloneword2];
return randomChoiceFromArray(variantArray);
break;

case 2:
//HOLY
var holyName = ["Mary","Matthew", "Mark", "Luke", "John", "Judas", "Joseph", "Cuthbert", "Bernice", "Sarah", "Rebecca", "Swithin"];
var holyNameFinal = randomChoiceFromArray(holyName);
